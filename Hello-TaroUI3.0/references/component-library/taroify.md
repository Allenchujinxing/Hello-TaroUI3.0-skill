...
1. Identify the page type, task flow, and component families from the current user request, product brief, design draft, HTML prototype, or implementation code.
